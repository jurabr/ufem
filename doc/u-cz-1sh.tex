...
okam¾itì a bez dal¹ích varování skonèil skonèil!}
...
\item {\em Potvrzovací tlaèítka}: slou¾í k ukoneèní nebo pøeru¹ení 
...
V¹echny vý¹e uvedené soubory se ukládají do jednoho odresáøe (slo¾ky).
...
V tabulce~\ref{typysoub} jsou uvedeny základní typy souobrù, které
...
více sad vlastnsotí koneèných prvkù s odli¹nými èísly ({\em Identifier}), co¾
...
zadání poètu dílku dìlení na hranách oblastí.\\

{\bf Poznámka:} {\em Program umo¾òuje poze tvorbu pravidelných sítí
koneèných prvkù. Proto je tøeba dbát na to, aby vzájemnì protilehlé hrany mìly
v¾dy nastaven stejný poèet dílkù.} \\

V zadaném pøípadì mají být v¹echny hrany rozdìlìny na $10$ dílky. To je
...
okraji modelu). Uzly je mo¾né vybírat buï jednotlive, a nebo pomocí
okna -- to se aktivuje pohybem  my¹i pøi stisknutémm levém tlaèítku.
...
programu.\footnote{uFEM nejprve ulo¾í výstup do souboru v praconím
...
V¾dy je k dispozici mo¾nost ulo¾ení auktuálního zobrazení v rastrovém formátu
