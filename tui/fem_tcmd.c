...
extern int func_gfx_sef_pal_minmax (char *cmd);
...
extern int func_fem_entity_lextrude (char *cmd);
...
extern int func_fill_var_prev_eres(char *cmd);
...
int fem_cmd_init (void)
{
  ...
  ciFunction[count].cmd = "fixplotcol";
  ciFunction[count].func = func_gfx_sef_pal_minmax ;
  count++;
  ...
  ciFunction[count].cmd = "lextrude";
  ciFunction[count].func = func_fem_entity_lextrude ;
  count++;
  ...
  ciFunction[count].cmd = "fillvarerestype";
  ciFunction[count].func = func_fill_var_prev_eres ;
  count++;
